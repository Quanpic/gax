...
(0, _ava2.default)('test', t => {
	...
	t.is(_rec._expr(_rec._capt(val, 'arguments/0'), {
		content: 't.is(val, 2)',
		filepath: 'test/export-file.test.js',
		line: 5,
		ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"is","range":[2,4]},"computed":false,"range":[0,4]},"arguments":[{"type":"Identifier","name":"val","range":[5,8]},{"type":"NumericLiteral","value":2,"range":[10,11]}],"range":[0,12]}',
		tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"is","range":[2,4]},{"type":{"label":"("},"range":[4,5]},{"type":{"label":"name"},"value":"val","range":[5,8]},{"type":{"label":","},"range":[8,9]},{"type":{"label":"num"},"value":2,"range":[10,11]},{"type":{"label":")"},"range":[11,12]}]',
		visitorKeys: _powerAssertVisitorKeys
	}), 2);
});
//# sourceMappingURL=../node_modules/.cache/ava/82748529a17eaa28519db7474784fdba.js.map