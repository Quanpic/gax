...
var _exportFile = require('../lib/build/export-file.js');

var _exportFile2 = _interopRequireDefault(_exportFile);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _ava2.default)('test', t => {
	var _rec = new _powerAssertRecorder();

	t.is(_rec._expr(_rec._capt(_rec._capt(_exportFile2.default, 'arguments/0/object').val, 'arguments/0'), {
		content: 't.is(exportFile.val, 2)',
		filepath: 'test/export-file.test.js',
		line: 5,
		ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"is","range":[2,4]},"computed":false,"range":[0,4]},"arguments":[{"type":"MemberExpression","object":{"type":"Identifier","name":"exportFile","range":[5,15]},"property":{"type":"Identifier","name":"val","range":[16,19]},"computed":false,"range":[5,19]},{"type":"NumericLiteral","value":2,"range":[21,22]}],"range":[0,23]}',
		tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"is","range":[2,4]},{"type":{"label":"("},"range":[4,5]},{"type":{"label":"name"},"value":"exportFile","range":[5,15]},{"type":{"label":"."},"range":[15,16]},{"type":{"label":"name"},"value":"val","range":[16,19]},{"type":{"label":","},"range":[19,20]},{"type":{"label":"num"},"value":2,"range":[21,22]},{"type":{"label":")"},"range":[22,23]}]',
		visitorKeys: _powerAssertVisitorKeys
	}), 2);
});
//# sourceMappingURL=../node_modules/.cache/ava/b3576ff375297b8b4882b2c0c9b1bfd2.js.map