...
(0, _ava2.default)('test', t => {
	...
	t.is(_rec._expr(_rec._capt(_ava2.default, 'arguments/0'), {
		content: 't.is(test, 2)',
		filepath: 'test/export-file_spec.js',
		line: 5,
		ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"is","range":[2,4]},"computed":false,"range":[0,4]},"arguments":[{"type":"Identifier","name":"test","range":[5,9]},{"type":"NumericLiteral","value":2,"range":[11,12]}],"range":[0,13]}',
		tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"is","range":[2,4]},{"type":{"label":"("},"range":[4,5]},{"type":{"label":"name"},"value":"test","range":[5,9]},{"type":{"label":","},"range":[9,10]},{"type":{"label":"num"},"value":2,"range":[11,12]},{"type":{"label":")"},"range":[12,13]}]',
		visitorKeys: _powerAssertVisitorKeys
	}), 2);
});
//# sourceMappingURL=../node_modules/.cache/ava/3d6342419471bb47942dd0bd889903b0.js.map